...
| 아이템 구매 테스트      | 1. 상점 진입 후 구매 선택 -> 원하는 아이템 선택 → 가격만큼 골드 감소 후 구매 확인 | 정상(Normal)     | 
| 아이템 판매 테스트      | 1. 상점 진입 후 판매 선택 -> 원하는 아이템 선택 → 가격의 60% 만큼 골드 증가 후 판매 확인 | 정상(Normal)     | 
| 아이템 숫자외 입력  | 1. 레벨 10 도달<br>2. 보스 몬스터 자동 소환 → 승리 시 게임 클리어               | 비정상(Abnormal) | 
